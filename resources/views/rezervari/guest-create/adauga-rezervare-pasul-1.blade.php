        ...
        <div class="col-md-9">
                        ...
                        <div class="form-row mb-0 d-flex justify-content-center border-radius: 0px 0px 40px 40px">
                            <div class="form-group col-lg-12 px-2 mb-0">
                                ...
                                <div class="form-row mb-2 justify-content-center"> 
                                    <div class="custom-control custom-switch col-lg-3 text-center py-1">
                                        <script type="application/javascript"> 
                                            turReturVechi={!! json_encode(old('tur_retur', false)) !!}
                                        </script>
                                        <input type="hidden" name="tur_retur" value="false" />
            ...
            :id="type.id" > --}}
                            ...
                            <input type="text" class="form-control" name="pasageri[buletin][]" v-model="buletin[index-1]"><br/>
                                ...
                                <div class="form-row mb-4 px-2 pt-2 d-flex justify-content-center align-items-center bg-secondary border rounded">                                    
                                    <div class="form-group col-lg-12 mb-2 d-flex justify-content-center border-bottom">
                                            <h5 class="mb-1">Costuri călătorie:</h5>
                                    </div>
                                    <div class="form-group col-lg-4 m-0 d-flex">
                                ...
                                <div class="form-row mb-1 d-flex justify-content-center align-items-center">
                                    ...
                                    <div v-if="tur_retur" class="form-group col-lg-4 d-flex justify-content-center align-items-end">
                                    ...
                                    <div class="form-group col-lg-12 border-left border-warning" style="border-width:5px !important">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="acord_de_confidentialitate">
                                                ...
                                                <a href="https://www.alsimymondtravel.ro/category/gdpr/" target="_blank">
