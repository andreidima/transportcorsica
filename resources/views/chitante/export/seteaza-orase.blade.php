            ...
            <div class="shadow-lg bg-white" style="border-radius: 40px 40px 40px 40px;">
                <div class="p-4 justify-content-center align-items-end" style="border-radius: 40px 40px 0px 0px; border:2px solid darkcyan">   
                    ...
                    <div class="col-lg-12 mb-0 d-flex justify-content-center">                 
                        <h1 class="" style="color:darkcyan">CHITANȚĂ</h1>
                    </div>
                </div>
                            ...
                            <div class="form-group col-lg-12 px-2 mb-0">
                                ...
                                <div class="form-row mb-4 d-flex justify-content-center">
                                    ...
                                    <div class="col-lg-2 mb-4">
                                        <label for="oras_plecare" class="mb-0">Oraș plecare:*</label>                                      
                                        <input 
                                            type="text" 
                                    ...
                                    <div class="col-lg-2 mb-5">
                                        <label for="oras_sosire" class="mb-0">Oraș sosire:*</label>                                      
                                        <input 
                                            type="text" 
                                            class="form-control form-control-sm {{ $errors->has('oras_sosire') ? 'is-invalid' : '' }}" 
                                            name="oras_sosire" 
                                            placeholder="" 
