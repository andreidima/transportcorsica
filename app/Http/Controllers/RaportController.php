    ...
    public function extrageRezervariIphone(Request $request){
        ...
        if($request->tip_lista === "lista_plecare"){
            if ($rezervari->first()->oras_plecare_tara ?? '' === 'Romania'){
                ...
                $rezervari = $rezervari->sortByDesc('oras_plecare_nume')->sortByDesc('oras_plecare_ordine')->sortBy('oras_plecare_traseu');
            }
            ...
            if ($rezervari->first()->oras_sosire_tara ?? '' === 'Corsica') {
                ...
                $rezervari = $rezervari->sortByDesc('oras_sosire_nume')->sortByDesc('oras_sosire_ordine')->sortBy('oras_sosire_traseu');
            }
        }
